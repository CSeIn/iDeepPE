...
from solver_BF import Solver
from models.conformer_cmgan import TSCNet
...
# General config
# Dataset
parser.add_argument('--tr-json', default="data/json/tr1spk-6ch.json",
                    help='path to tr.json')
parser.add_argument('--cv-json', default="data/json/dt1spk-6ch.json",
                    help='path to cv.json')
...
# save and load model
parser.add_argument('--save-folder', default='out/BF_',
...
if __name__ == '__main__':
    ...
    wandb.run.name = 'BF_experiment' #Set a name for the run
    main(args)
